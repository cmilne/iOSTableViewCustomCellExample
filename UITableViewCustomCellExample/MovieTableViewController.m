...
- (void)viewDidLoad {
    ...
    self.movieArray = [NSArray arrayWithObjects:@"big_buck_bunny", @"big_buck_bunny", @"big_buck_bunny", @"big_buck_bunny", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString* customCellIdentifier = @"CustomTableViewCellIdent";
    ...
    cell = (CustomTableViewCell*)[tableView dequeueReusableCellWithIdentifier:customCellIdentifier];
    
    cell.layoutMargins = UIEdgeInsetsZero;
    [cell setupMoviePlayer:[self.movieArray objectAtIndex:[indexPath row]]];
